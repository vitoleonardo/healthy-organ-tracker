...
class CFG:
    ...
    def __init__(self,img_dims=(128,128,3), model='UNet', batch_size=16, epochs=50, kaggle=True, use_fold_csv=True, backbone='efficientnetb0', lr_patience=5, semi3d_data=True):
